...
I'll be updating it periodically with new images, as new devices come online with firmware support.
...
# How to use.
This data is provided for users that run variations of Liam Cottle's [Meshtatic Map](https://github.com/liamcottle/meshtastic-map)
When there is updates to hardware or roles, please copy and replace the data in the files of /json & /images with those that are found here. 
